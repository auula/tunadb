...
func (v PortValidator) Validate(opt *ServerOptions) error {
	return validatePort(opt.Port)
}

type PathValidator struct{}

func (v PathValidator) Validate(opt *ServerOptions) error {
	return validatePath(opt.Path)
}

type AuthValidator struct{}

func (v AuthValidator) Validate(opt *ServerOptions) error {
